...
<%@page import="project.project22_jspcrudfullstack.ForumDAO, project.project22_jspcrudfullstack.ForumVO"%>
<%
...
<body>
<div class="container">
    <form class="row g-3 needs-validation" action="edit_ok.jsp" novalidate>
        <div class="col-md-2">
            <input type="text" class="form-control" name="id" value="<%=forum_post.getId()%>" hidden required>
